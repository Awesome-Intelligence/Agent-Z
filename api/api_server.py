...
AnythingLLM, NextChat, ChatBox, etc.) can connect to handsome-agent
through this adapter by pointing at http://localhost:8001/v1.

Requires:
- aiohttp
"""

# 🏃 Execution - 🛠️ ToolExec - OpenAI-compatible API Server
...
class APIServerAdapter:
    ...
    async def _handle_capabilities(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({
            "object": "handsome.api_server.capabilities",
            "platform": "handsome-agent",
...
def create_api_server(config: Optional[Dict[str, Any]] = None) -> APIServerAdapter:
    """Create and return an API server adapter instance."""
