"""BuiltinMemoryProvider — Built-in Memory Provider

Implements multi-layer memory architecture:
1. Episodic Memory - Short-term memory for current session
2. User Profile - Long-term user preferences and information
3. Factual Memory - Stored facts and knowledge
4. Skill Memory - Skill usage history and patterns

Based on Hermes's multi-layer memory design.
"""
...
class BuiltinMemoryProvider(BaseMemoryProvider):
    """Built-in memory provider with multi-layer memory support"""
    ...
    def __init__(self):
        ...
        self._episodic_memory: List[Dict[str, Any]] = []      # Episodic memory
        self._user_profile: Dict[str, Any] = {}               # User profile
