"""
Simplified Agent Core

Demonstrates how to remove intent recognition layer and use LLM for direct decision-making.
...
Key changes:
1. Remove IntentClassifier
2. Remove IntentResult
3. LLM directly sees tool list and decides which to use
4. Simplified decision flow
"""
...
新代码：
  from agent.llm_tool_selector import SimplifiedAgent
