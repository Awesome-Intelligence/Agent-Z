...
from common.logging_manager import get_decision_logger, get_execution_logger, get_llm_logger, get_tool_logger
from common.environment import env_detector
...
"""
    ...
    if llm_provider:
        try:
            ...
            if session_history:
                from agent.llm.base import Message as LLMMessage
                messages_for_llm = []
                for msg in session_history:
                    if isinstance(msg, dict):
