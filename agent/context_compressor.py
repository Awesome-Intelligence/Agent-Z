"""Context Compressor - Context Compression Engine

Based on Hermes Agent's context compression mechanism, implements lossy summarization compression.

Features:
1. Automatic context length detection
2. Intelligent content selection for compression
3. Summary generation preserving key information
4. Maintenance of parent-child relationships in compression history
"""
