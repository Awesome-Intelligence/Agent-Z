"""
Core Agent Loop - ReAct Implementation
Hermes Core logic - LLM reasoning + self-evolution
"""
...
if TYPE_CHECKING:
    ...
    from .skills import SelfEvolutionManager


logger = get_decision_logger("AgentLoop")
...
class AgentLoop:
    ...
    def __init__(
        ...
        self.logger = get_decision_logger("AgentLoop")
    ...
    async def start_self_evolution(self) -> None:
        ...
        if self._self_evolution is None:
            try:
                from skills import get_self_evolution_manager
