"""
Brain Service - Decision Layer Core Service
Wraps Hermes Core as HTTP/RPC service
Integrates self-evolution capabilities (TrajectoryRecorder + Curator)
"""
...
from gateway.message import StandardMessage, MessageChannel
from gateway.message_proto import MessageProtocol
from .agent_loop import AgentLoop, AgentConfig as LoopConfig
from .trajectory import TrajectoryRecorder, Trajectory, TrajectoryStatus
from .curator import Curator, EvaluationReport
from common.logging_manager import get_decision_logger


logger = get_decision_logger("BrainService")
...
class BrainService:
    ...
    def initialize(self) -> None:
        ...
        if self.config.enable_curator and self._trajectory_recorder:
            from .curator import SkillWriter
    ...
    def _register_routes(self) -> None:
        ...
        async def list_skills():
            """列出所有已安装的技能"""
            from skills import get_skill_telemetry, load_skills_from_directory
