"""
Self-Evolution Integration Manager

Integrates all self-evolution components:
- SkillTelemetry: Skill usage tracking
- SkillLifecycleManager: Skill lifecycle management
- EnhancedCurator: Auto review and skill synthesis
- SkillMerger: Skill merging

Provides unified self-evolution capabilities for AgentLoop
"""
...
class SelfEvolutionManager:
    ...
    def _initialize_components(self) -> None:
        ...
        if self.config.enable_merger:
            try:
                from skills import SkillMerger
...
def get_self_evolution_manager() -> SelfEvolutionManager:
    """Get global self-evolution manager"""
